...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $query = "SELECT email FROM tenants_account_details where email = '$email'";
...
//save to database
        ...
        $query = "insert into tenants_account_details (user_id, first_name, middle_name, last_name, email, phone_number, username, password, newaccountstatus) values ('$user_id', '$first_name', '$middle_name', '$last_name', '$email', '$phone_number', '$username', '$password', '1')";
